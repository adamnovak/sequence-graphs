...
std::vector<OldNaturalMappingScheme::Matching>
    OldNaturalMappingScheme::findMaxMatchings(const std::string& query) const {
...
std::vector<OldNaturalMappingScheme::Matching>
    OldNaturalMappingScheme::findMinMatchings(const std::string& query) const {
...
std::vector<Mapping> OldNaturalMappingScheme::naturalMap(
...
void OldNaturalMappingScheme::scan(SyntenyBlock& block,
    const std::string& query) const {
...
size_t OldNaturalMappingScheme::countMismatches(const std::string& query,
...
void OldNaturalMappingScheme::map(const std::string& query,
